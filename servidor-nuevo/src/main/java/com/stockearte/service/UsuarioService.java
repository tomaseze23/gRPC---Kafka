...
import com.stockearte.repository.UsuarioRepository;
...
public class UsuarioService extends UsuarioServiceGrpc.UsuarioServiceImplBase {
    ...
    @Override
    public void createUsuario(com.proto.service.Usuario request,
            StreamObserver<com.proto.service.Usuario> responseObserver) {
        ...
        com.proto.service.Usuario response = com.proto.service.Usuario.newBuilder()
    ...
    @Override
    public void getUsuario(com.proto.service.Usuario request,
            StreamObserver<com.proto.service.Usuario> responseObserver) {
    ...
    public void listUsuarios(ListUsuariosRequest request, StreamObserver<UsuarioList> responseObserver) {
        ...
        UsuarioList response = UsuarioList.newBuilder()
                .addAllUsuarios(usuarios.stream().map(usuario -> com.proto.service.Usuario.newBuilder()
                        .setId(usuario.getId())
                        .setNombreUsuario(usuario.getNombreUsuario())
                        .setContrasena(usuario.getContrasena())
                        .setNombre(usuario.getNombre())
    ...
    @Override
    public void updateUsuario(com.proto.service.Usuario request,
            StreamObserver<com.proto.service.Usuario> responseObserver) {
